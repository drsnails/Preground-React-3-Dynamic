    ...
    return (
        <section className="about">
            ...
            <section className="dynamic-cmps">
                <DynamicCmp cmpType={cmpType} name="Popo" age={20} handleClick={handleGreetClick} />
...
function DynamicCmp({ cmpType, ...restOfProps }) {
    switch (cmpType) {
        case 'hello':
            return <Hello {...restOfProps} />
        case 'goodbye':
            return <GoodBye {...restOfProps} />
        case 'welcomeBack':
            return <WelcomeBack {...restOfProps} />
    }
